              ...
              <div className="col-12 col-md-4 px-5">
                <div className="d-flex flex-column justify-content-center align-items-center">
                  ...
                  <p className="poppins-18-500 text-justify">
                    ...
                    from growing their wealth. We try to shoot those myths with
                    our Literacy gun.
                  </p>
                </div>
              </div>
              <div className="col-12 col-md-4 px-5">
                <div className="d-flex flex-column justify-content-center align-items-center">
                  ...
                  <p className="poppins-18-500 text-justify">
                    ...
                    better rather than being in an illusion. While Past numbers
                    doesn’t gurantee future growth but it does significantly
              ...
              <div className="col-12 col-md-4 px-5">
                <div className="d-flex flex-column justify-content-center align-items-center">
                  ...
                  <p className="poppins-18-500 text-justify">
                    ...
                    stage are filled with so many doubts that QnA becomes a
                    Value Bomb in itself
                  </p>
                </div>
              </div>
            </div>
