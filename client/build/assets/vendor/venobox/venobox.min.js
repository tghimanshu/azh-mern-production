        ...
        this.each(function () {
          ...
          (ee.VBclose = function () {
            ...
            N.on("click", function (k) {
              ...
              switch (
                ...
                (H = N.data("share")),
                (E = '<div className="vbox-preloader">'),
                se.spinner)
              ) {
                case "rotating-plane":
                  E += '<div className="sk-rotating-plane"></div>';
                  break;
                case "double-bounce":
                  E +=
                    '<div className="sk-double-bounce"><div className="sk-child sk-double-bounce1"></div><div className="sk-child sk-double-bounce2"></div></div>';
                  break;
                case "wave":
                  E +=
                    '<div className="sk-wave"><div className="sk-rect sk-rect1"></div><div className="sk-rect sk-rect2"></div><div className="sk-rect sk-rect3"></div><div className="sk-rect sk-rect4"></div><div className="sk-rect sk-rect5"></div></div>';
                  break;
                case "wandering-cubes":
                  E +=
                    '<div className="sk-wandering-cubes"><div className="sk-cube sk-cube1"></div><div className="sk-cube sk-cube2"></div></div>';
                  break;
                case "spinner-pulse":
                  E += '<div className="sk-spinner sk-spinner-pulse"></div>';
                  break;
                case "chasing-dots":
                  E +=
                    '<div className="sk-chasing-dots"><div className="sk-child sk-dot1"></div><div className="sk-child sk-dot2"></div></div>';
                  break;
                case "three-bounce":
                  E +=
                    '<div className="sk-three-bounce"><div className="sk-child sk-bounce1"></div><div className="sk-child sk-bounce2"></div><div className="sk-child sk-bounce3"></div></div>';
                  break;
                case "circle":
                  E +=
                    '<div className="sk-circle"><div className="sk-circle1 sk-child"></div><div className="sk-circle2 sk-child"></div><div className="sk-circle3 sk-child"></div><div className="sk-circle4 sk-child"></div><div className="sk-circle5 sk-child"></div><div className="sk-circle6 sk-child"></div><div className="sk-circle7 sk-child"></div><div className="sk-circle8 sk-child"></div><div className="sk-circle9 sk-child"></div><div className="sk-circle10 sk-child"></div><div className="sk-circle11 sk-child"></div><div className="sk-circle12 sk-child"></div></div>';
                  break;
                case "cube-grid":
                  E +=
                ...
                case "folding-cube":
                  E +=
                    '<div className="sk-folding-cube"><div className="sk-cube1 sk-cube"></div><div className="sk-cube2 sk-cube"></div><div className="sk-cube4 sk-cube"></div><div className="sk-cube3 sk-cube"></div></div>';
              }
              return (
                (E += "</div>"),
                (D =
                ...
                (l =
                  ...
                  I +
                  D +
                  '<div className="vbox-share"></div></div>'),
          ...
          function be() {
            e.ajax({ url: v, cache: !1 })
              .done(function (e) {
                n.html('<div className="vbox-inline">' + e + "</div>"), ge();
              })
              .fail(function () {
                n.html(
          ...
          function he() {
            n.html('<iframe className="venoframe" src="' + v + '"></iframe>'),
              me();
          }
          function ke(e) {
            var s,
          ...
          function pe() {
            n.html('<div className="vbox-inline">' + e(v).html() + "</div>"),
              me();
          }
          function ge() {
            (j = n.find("img")).length
